...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
  ...
  Route::group(['prefix' => 'states'], function () {
    Route::get('/', \App\Http\Controllers\State\IndexController::class)->name('state.index');
    Route::get('/create', \App\Http\Controllers\State\CreateController::class)->name('state.create');
    Route::post('/', \App\Http\Controllers\State\StoreController::class)->name('state.store');
    Route::get('/{state}/edit', \App\Http\Controllers\State\EditController::class)->name('state.edit');
    Route::get('/{state}', \App\Http\Controllers\State\ShowController::class)->name('state.show');
    Route::patch('/{state}', \App\Http\Controllers\State\UpdateController::class)->name('state.update');
    Route::delete('/{state}', \App\Http\Controllers\State\DeleteController::class)->name('state.delete');
  });
});
