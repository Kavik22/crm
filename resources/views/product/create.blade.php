  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <select name="category_id" multiple class="form-control select2" style="width: 100%;">
        ...
        <div class="form-group">
          <select name="colors[]" class="form-control select2" multiple="multiple" data-placeholder="Select a color"
            style="width: 100%;">
